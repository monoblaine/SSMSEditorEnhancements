...
namespace SSMSEditorEnhancements.Commands.ReplaceAllSquareBracketsWithDoubleQuotes {
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class ReplaceAllSquareBracketsWithDoubleQuotesCommand {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const Int32 CommandId = 4134;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceAllSquareBracketsWithDoubleQuotesCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private ReplaceAllSquareBracketsWithDoubleQuotesCommand (AsyncPackage package, OleMenuCommandService commandService) {
        ...
        /// </summary>
        public static ReplaceAllSquareBracketsWithDoubleQuotesCommand Instance { get; private set; }
        ...
        public static async Task InitializeAsync (AsyncPackage package) {
            // Switch to the main thread - the call to AddCommand in ReplaceAllSquareBracketsWithDoubleQuotesCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            var commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;

            Instance = new ReplaceAllSquareBracketsWithDoubleQuotesCommand(package, commandService);
        }
